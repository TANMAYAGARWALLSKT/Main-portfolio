  ...
  return (
    <section>
      ...
      >
        ...
        <div
          className="absolute flex justify-center left-[14vw] content-center flex-wrap w-screen h-screen  sm:text-[10vw] lg:text-[6vw] md:text-[10vw] outfituniquifier overflow-hidden text-zinc-300"
          id="mian"
        >
          <div
